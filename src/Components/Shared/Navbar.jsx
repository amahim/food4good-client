...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full z-50 bg-[#F0EBE1] shadow-md">
      <div className="py-5">
          ...
          <div className="flex gap-4 items-center navbar-end">
            <div>
              {user && user?.email ? (
                ...
                <div className="flex gap-4 items-center">
                  <Link to="/login" className="text-[#262522] rounded-lg font-bold">
                    Login
                  </Link>
                  <Link to="/register" className="btn bg-[#262522] border-none text-white rounded-full">
                    Register
                  </Link>
                </div>
              )}
