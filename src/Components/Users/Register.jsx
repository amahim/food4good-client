...
const Register = () => {
  ...
  return (
    <div className="md:w-2/5 mx-auto w-4/5">
      <div>
        <h1 className="pb-5 text-center text-[#262522] font-bold text-2xl">Register your account</h1>
      </div>
      <form onSubmit={handleRegSubmit} className="border-[#ee6352] card-body border-2 rounded-xl mt-5 shadow-xl">
        ...
        <div>
          <h1>
            Already have an account? <Link to="/login" className="text-[#ee6352]">Login</Link>
          </h1>
        </div>
      </form>
    </div>
